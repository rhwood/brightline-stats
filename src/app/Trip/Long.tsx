...
const Long: React.FunctionComponent = () => (
  <PageSection hasBodyWrapper={false}>
    <Title headingLevel="h1" size="lg">Long Distance Trips</Title>
    <Content>
      <Title headingLevel="h3">Ridership</Title>
      <MultiYearMonthlyRidershipChart lineFn={(row: BrightlineStats): number => row.long} />
      <Title headingLevel={ContentVariants.h3}>Average Fare per Passenger</Title>
      <MultiYearMonthlyFareChart lineFn={(row: BrightlineStats): number => row.long} />
      <Title headingLevel={ContentVariants.h3}>Revenues (in millions of dollars)</Title>
      <MultiYearMonthlyRevenueChart lineFn={(row: BrightlineStats): number => row.long} />
